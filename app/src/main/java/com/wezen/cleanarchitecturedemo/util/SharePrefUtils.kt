...
object SharePrefUtils {
    ...
    private const val PREF_NAME = "CAPref"
    ...
    fun getString(key: String, defaultValue: String = ""): String {
        ...
        return sharePref.getString(key, defaultValue)?.trim() ?: defaultValue
    }
    ...
    fun getNetworkKey() = getString("network_key", "")
    fun setNetworkKey(networkKey: String) = saveKey("network_key", networkKey)
}